...
exports.handler = async (event) => {
  ...
  // Property scraping moved to dedicated background function: scrape-properties-background.js
  // This keeps the auction scraper fast (< 10s) and avoids timeouts.
  ...
  console.log(`[scraper] Complete in ${elapsed}s. Auctions found: ${totalFound}, added: ${totalAdded}. Pulse: ${pulseGenerated}, Cleaned: ${cleaned}`);
